...
if("TRUE" STREQUAL "TRUE")
  set(car_SOURCE_PREFIX /home/ezra/car/src/car)
  set(car_DEVEL_PREFIX /home/ezra/car/devel/.private/car)
  set(car_INSTALL_PREFIX "")
  set(car_PREFIX ${car_DEVEL_PREFIX})
else()
  set(car_SOURCE_PREFIX "")
  set(car_DEVEL_PREFIX "")
  set(car_INSTALL_PREFIX /home/ezra/car/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'car' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ezra <ezra@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'car' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ezra/car/src/car/${idir}'.  Ask the maintainer 'ezra <ezra@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ezra/car/devel/.private/car/lib;/home/ezra/car/devel/lib;/opt/ros/kinetic/lib)
